...
export default function AdminDashboard() {
  ...
  const fetchPublicStats = async () => {
    try {
      ...
      const response = await axios.get(
        "https://lightsteelblue-woodcock-286554.hostingersite.com/api/admin/public-stats",
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json"
  ...
  const updateHeroSection = async () => {
    try {
      ...
      const response = await axios.put(
        `https://lightsteelblue-woodcock-286554.hostingersite.com/api/admin/hero-sections/${heroData.id}`,
        updateData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const uploadHeroImage = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://lightsteelblue-woodcock-286554.hostingersite.com/api/admin/hero-sections/${heroData.id}/upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
