...
function AddVideoResources() {
  ...
  const fetchVideoResources = async () => {
    try {
      setLoading(true)
      const response = await fetch('https://lightsteelblue-woodcock-286554.hostingersite.com/api/video-resources')
  ...
  const handleAddVideo = async () => {
    ...
    try {
      ...
      const response = await fetch('https://lightsteelblue-woodcock-286554.hostingersite.com/api/admin/video-resources', {
        method: 'POST',
        headers: {
  ...
  const handleDeleteVideo = async (id) => {
    ...
    try {
      const response = await fetch(`https://lightsteelblue-woodcock-286554.hostingersite.com/api/admin/video-resources?id=${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${adminToken}`
        }
